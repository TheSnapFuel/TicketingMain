...
export class SeatPicker extends Component {
	...
	render() {
		return (
			<div className="seat-content flex">
				<div className={this.props.loading ? 'loader' : null} />
				<div className="seat-picker ml-52">{this.renderRows()}</div>
				<div className="ml-32 flex flex-col items-center justify-center">
					<div className="flex flex-col justify-center items-center my-3">
						<span className="w-6 h-6 bg-[#9b9797] rounded-full mb-2"></span>
						Reserved
					</div>
					<div className="flex flex-col items-center my-3">
						<span className="w-6 h-6 bg-white rounded-full mb-2"></span>
						Available
					</div>
					<div className="flex flex-col items-center my-3">
						<span className="w-6 h-6 bg-accent rounded-full mb-2"></span>
						Selected
					</div>
				</div>
			</div>
